# 🚀 JabarLine - Integrasi Google Sheets sebagai CMS

**Gunakan Google Sheets sebagai database artikel untuk website JabarLine. Generator otomatis membuat HTML dan memperbarui konten dengan mudah!**
...
# 1. Buat project (misal: "JabarLine-News")
